...
# store the position of backward locator
...
execute store result score @s motion_x2 run data get entity @n[type=interaction,limit=1,tag=backward] Pos[0] 1000
execute store result score @s motion_z2 run data get entity @n[type=interaction,limit=1,tag=backward] Pos[2] 1000
