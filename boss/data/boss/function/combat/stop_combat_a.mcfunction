...
execute as @a[tag=emperor] run tag @s add stopping_combat_a
execute as @a[tag=emperor] run tag @s remove walking_combat_a

execute as @e[tag=emperor] run say stopping combat_a!
